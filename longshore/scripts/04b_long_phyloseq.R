...
allTax <- read_csv("03_long_subsetTaxa_phyloseq.csv")
echinoTax <- read_csv("04_long_echinoTaxa_phyloseq.csv")

taxmat <- left_join(allTax, echinoTax,
                        by="otuID")

write_csv(taxmat, "05_long_subsetTaxa_echinoBOLD_phyloseq.csv")
...
my_blu1 = c("#C6DBEF","#6BAED6", "#4292C6", "#2171B5")
...
ggsave(# _plot name_ if you have it, else it will save the last one printed 
  filename = "/Users/uqibyrne/Desktop/hons_manuscript_2023/longshore/figures/long_counts_main_25x20.png", 
